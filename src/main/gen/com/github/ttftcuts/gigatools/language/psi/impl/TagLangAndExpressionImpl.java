...
public class TagLangAndExpressionImpl extends ASTWrapperPsiElement implements TagLangAndExpression {

  public TagLangAndExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<TagLangUnaryExpression> getUnaryExpressionList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, TagLangUnaryExpression.class);
  }
