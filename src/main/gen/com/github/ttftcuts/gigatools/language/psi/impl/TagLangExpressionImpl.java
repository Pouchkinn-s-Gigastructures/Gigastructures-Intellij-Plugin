...
public class TagLangExpressionImpl extends ASTWrapperPsiElement implements TagLangExpression {

  public TagLangExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public TagLangOrExpression getOrExpression() {
    return findNotNullChildByClass(TagLangOrExpression.class);
  }
